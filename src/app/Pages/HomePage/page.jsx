...
const getStatusStyles = (status) => {
    switch (status) {
        case "taken": return { className: styles.statusTaken, icon: <Icons.Check width={16} height={16} />, label: "Assunto", rowClass: '' };
        case "pending": return { className: styles.statusPending, icon: <Icons.Clock width={16} height={16} />, label: "Ora", rowClass: styles.scheduleItemPending };
        default: return { className: styles.statusLater, icon: <Icons.Clock width={16} height={16} />, label: "Più tardi", rowClass: styles.scheduleItemDefault };
    }
};
                                ...
                                <div className={styles.card}>
                                    <div className={styles.cardHeader}>
                                        ...
                                        <Link href="Terapie" className={styles.cardLink}>
                                            Vedi tutto <Icons.ChevronRight width={16} height={16} />
                                        </Link>
                                    </div>
                            ...
                            {isLoading ? (
                                ...
                                <div className={styles.card}>
                                    <div className={`${styles.cardHeader} ${styles.alertHeaderLow}`}>
                                        ...
                                        <Link href="Armadietto" className={styles.cardLink}><Icons.ChevronRight width={16} height={16} /></Link>
                                    </div>
